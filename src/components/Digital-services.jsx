...
const services = [
  ...
  },
  {
    ...
    fullDesc:
      "A beautiful website is useless if your customers can't find it. Our Search Engine Optimization (SEO) service ensures your business ranks prominently on Google for the keywords that matter most to your industry. We take a holistic approach, combining technical SEO (improving site speed and structure), on-page SEO (optimizing content and meta tags), and off-page SEO (building high-quality backlinks). We constantly adapt to changing search engine algorithms to keep your site compliant and competitive. By improving your visibility organically, we drive consistent, high-quality traffic to your site, reducing your dependency on paid ads and establishing your brand as a long-term industry authority.",
    icon: <FaServer />,
  },
  {
    ...
    fullDesc:
      "Your business is unique, and a generic template often fails to capture your specific operational needs. Our Customized Web Development service builds robust, scalable digital solutions from the ground up. Specializing in modern technologies (like the MERN stack), we create websites that are lightning-fast, secure, and fully responsive across all devices. Whether you need a complex e-commerce platform, a dynamic corporate site, or a custom web application, we code with performance and User Experience (UX) in mind. We ensure the backend is powerful enough to handle growth while the frontend offers a seamless, engaging journey for your visitors.",
    icon: <FaTools />,
  },
];
